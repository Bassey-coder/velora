    ...
    return (
        <main className="bg-white shadow shadow-gray-200 w-full">
            <div className="flex justify-between items-center pt-3 px-5 h-[60px]">
                ...
                <p className="hidden md:block w-[80px] h-[40px] bg-blue-500 text-white flex justify-center pt-1"><Link href="/auth/signin">SignIn</Link></p>
               <div className="block md:hidden">
                <FaGripLines className=" relative text-xl cursor-pointer text-blue-500" onClick={toggleMenu} />
               </div>
            </div>
            {menuOpen && (
